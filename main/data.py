...
class NewsData():
    ...
    def __init__(self, _id, title, image_url, description, content, url):
        self.id = _id
        self.title = title
...
def all_news():
    ...
    if _all_news is None:
        ...
        for i, doc in enumerate(docs):
            news_data = NewsData(str(doc["_id"]), doc['title'], doc['image_url'], doc['description'], doc['contents'], doc['url'])
